...
export default function ForClient() {
    ...
    }, [searchQuery, category, location, date, priceRange]);
            ...
            <div className="bg-white p-4 rounded-2xl border border-gray-100 shadow-sm flex flex-col md:flex-row gap-4 items-center">
                <div className="flex-1 w-full md:w-auto relative">
                    ...
                    <input
                        ...
                        className="w-full pl-9 pr-4 py-2 bg-gray-50 border border-gray-100 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-orange-100 transition-all text-black"
                    />
                </div>
                <div className="flex-1 w-full md:w-auto relative">
                    <input
                        ...
                        className="w-full px-4 py-2 bg-gray-50 border border-gray-100 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-orange-100 transition-all text-black"
                    />
                </div>
                <div className="flex items-center gap-2 w-full md:w-auto">
                    <input
                        ...
                        className="w-full md:w-24 px-3 py-2 bg-gray-50 border border-gray-100 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-orange-100 transition-all text-black"
                    />
                ...
                {(location || date || priceRange.min || priceRange.max) && (
                    <button
                        onClick={() => {
                            setLocation('');
                            setDate('');
                        ...
                        className="px-4 py-2 text-red-500 text-sm font-medium hover:bg-red-50 rounded-xl transition-all cursor-pointer whitespace-nowrap"
                    >
                        Clear Filters
                    </button>
                )}
